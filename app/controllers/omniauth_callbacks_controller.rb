require 'koala'
  ...
  class OmniauthCallbacksController < DeviseTokenAuth::ApplicationController
    ...
    def facebook_koala
      Koala::Facebook::API.new(auth_hash['credentials']['token'])
    end
    ...
    def omniauth_success
      ...
      #
      # @user_info = facebook_koala.get_object(:me, { fields: [:last_name, :email]})
      ...
      if !@resource.valid?
        @resource.errors["email"][0] = " (from your Facebook account) is already registered , use 'forgot password?' to retrive your password"
    ...
    def render_data_or_redirect(message, data, user_data = {})
      ...
      if ['inAppBrowser', 'newWindow'].include?(omniauth_window_type)
        ...
        redirect_to DeviseTokenAuth::Url.generate(auth_origin_url, data.merge(blank: true,oauth_registration: @oauth_registration))
      else
